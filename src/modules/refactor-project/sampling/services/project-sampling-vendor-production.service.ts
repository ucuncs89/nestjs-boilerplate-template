...
import {
  ...
  ProjectSamplingVendorProductionLossPercentageDto,
} from '../dto/project-sampling-vendor-production.dto';

@Injectable()
export class ProjectSamplingVendorProductionService {
  constructor(
  ...
  async createVendorProductionActivity(
    project_detail_id,
    projectSamplingVendorProductionDto: ProjectSamplingVendorProductionDto,
    user_id,
    i18n,
  ) {
    try {
  ...
  async updateLossPercentage(
    project_detail_id,
    projectSamplingVendorProductionLossPercentageDto: ProjectSamplingVendorProductionLossPercentageDto[],
    user_id,
    i18n,
  ) {
    ...
    try {
      if (
        Array.isArray(projectSamplingVendorProductionLossPercentageDto) &&
        projectSamplingVendorProductionLossPercentageDto.length > 0
      ) {
        for (const data of projectSamplingVendorProductionLossPercentageDto) {
      ...
      return projectSamplingVendorProductionLossPercentageDto;
    } catch (error) {
