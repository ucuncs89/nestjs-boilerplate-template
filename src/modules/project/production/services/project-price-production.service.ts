...
@Injectable()
export class ProjectPriceProductionService {
  constructor(
  ...
  async updatePriceAdditional(
    ...
    try {
      await this.projectPriceAdditionalRepository.update(
        ...
        {
          additional_name: projectPriceCostProductionDto.additional_name,
          additional_price: projectPriceCostProductionDto.additional_price,
          description: projectPriceCostProductionDto.description,
          updated_at: new Date().toISOString(),
          updated_by: user_id,
        },
      );
      return { id: additional_price_id, ...projectPriceCostProductionDto };
    } catch (error) {
      throw new AppErrorException(error);
    }
  }
