...
import { ProjectProductionRecapController } from './production/controllers/project-production-recap.controller';
...
@Module({
  ...
  controllers: [
    ...
    ProjectProductionRecapController,
    ...
    ProjectProformaInvoiceController,
  ],
  providers: [
    ProjectService,
    ProjectSizeService,
