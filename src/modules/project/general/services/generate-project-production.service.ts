...
@Injectable()
export class GenerateProjectProductionService {
  constructor(
  ...
  async generateProductionProject(
    ...
    const oldProjectDetail =
      await this.projectDetailService.findProjectDetailPlanning(project_id);
    ...
    //   i18n,
    // );
    return { arrFabric, arrSewing, arrPackaging, oldVariant };
  }
}
